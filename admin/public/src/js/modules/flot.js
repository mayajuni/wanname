app
    ...
    .directive('pieDonut', function(){
        return {
            ...
            restrict: 'A',
            link: function(scope, element, attrs){
                var colors = ['#F44336', '#03A9F4', '#8BC34A', '#FFEB3B', '#009688'];
                var pieData = scope.chartDatas;
                ...
                $("#pie-chart").bind("plotclick", function(event, pos, obj){
                    scope.chartClick(obj);
                    scope.$apply();
                });
                ...
                if($('#donut-chart')[0]){
                    ...
                    $("#donut-chart").bind("plotclick", function(event, pos, obj){
                        scope.chartClick(obj);
                        scope.$apply();
                    });
                }
